...
<body>
  ...
  <main class="p-5">
    <div class="container icard-color d-flex flex-column align-items-center" style="width:60%">
        <div>
        <h2 class="text-white text-center fs-2 fw-semibold">Estamos desenvolvendo!</h2>
        </div>

        <div>
            <p class="text-white text-center fs-3">Infelizmente ainda não está no ar :/</p>
        </div>
        <button class="btn btn-dark p-1"><a class="text-white fs-5 fw-semibold text-decoration-none" href="../../index.php">Voltar</a></button>
    </div>
  </main>
